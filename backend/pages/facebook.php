...
";
$resultfacebook = $conn->query($sqlfacebook);
?>
    ...
    <div class="container-fluid">
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                <div class="card-title">Facebook Customers</div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover text-nowrap align-middle">
                        ...
                        <?php 
                        $sno = 1;
                        if ($resultfacebook && $resultfacebook->num_rows > 0): 
                            while($row = $resultfacebook->fetch_assoc()): ?>
                            <tr>
                                <td><?= $sno++; ?></td>
            ...
            <div class="card-footer border-top-0">
                <div class="d-flex justify-content-between">
                    <div>Showing <b>1</b> to <b><?= $resultfacebook ? $resultfacebook->num_rows : 0 ?></b> entries</div>
