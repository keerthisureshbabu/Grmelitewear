...
FROM customers c
LEFT JOIN order_addresses o
  ON c.mobile_num = o.mobile
WHERE o.mobile IS NULL
    ...
    <div class="container-fluid">
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                <div class="card-title">New Customer's</div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover text-nowrap align-middle">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="5" class="text-center py-4">No new customers found</td>
                            </tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
            ...
            <div class="card-footer border-top-0">
                <div class="d-flex justify-content-between">
                    <div>Showing <b>1</b> to <b><?= $result ? $result->num_rows : 0 ?></b> entries</div>
