...
// ----------------- MAIN DATA for OLD customers -----------------
$sqlOld = "
SELECT c.origin, c.mobile_num, c.name, c.created_at
FROM customers c
JOIN order_addresses o ON c.mobile_num = o.mobile
GROUP BY c.mobile_num, c.origin, c.name, c.created_at
    ...
    <div class="container-fluid">
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                <div class="card-title">Old Customer's</div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover text-nowrap align-middle">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="5" class="text-center py-4">No old customers found</td>
                            </tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
            ...
            <div class="card-footer border-top-0">
                <div class="d-flex justify-content-between">
                    <div>Showing <b>1</b> to <b><?= $resultOld ? $resultOld->num_rows : 0 ?></b> entries</div>
