...
";
$resultdirect = $conn->query($sqldirect);
?>
    ...
    <div class="container-fluid">
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                <div class="card-title">Direct Customers</div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover text-nowrap align-middle">
                        ...
                        <?php 
                        $sno = 1;
                        if ($resultdirect && $resultdirect->num_rows > 0): 
                            while($row = $resultdirect->fetch_assoc()): ?>
                            <tr>
                                <td><?= $sno++; ?></td>
            ...
            <div class="card-footer border-top-0">
                <div class="d-flex justify-content-between">
                    <div>Showing <b>1</b> to <b><?= $resultdirect ? $resultdirect->num_rows : 0 ?></b> entries</div>
