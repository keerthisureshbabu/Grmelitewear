...
";
$resultInsta = $conn->query($sqlInsta);
?>
    ...
    <div class="container-fluid">
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                <div class="card-title">Instagram Customers</div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover text-nowrap align-middle">
                        ...
                        <?php 
                        $sno = 1;
                        if ($resultInsta && $resultInsta->num_rows > 0): 
                            while($row = $resultInsta->fetch_assoc()): ?>
                            <tr>
                                <td><?= $sno++; ?></td>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="5" class="text-center py-4">No Instagram customers found</td>
                            </tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
            ...
            <div class="card-footer border-top-0">
                <div class="d-flex justify-content-between">
                    <div>Showing <b>1</b> to <b><?= $resultInsta ? $resultInsta->num_rows : 0 ?></b> entries</div>
