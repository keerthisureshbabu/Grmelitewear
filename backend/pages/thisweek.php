      ...
      <div class="col-12">
        <div class="card custom-card bg-primary-transparent border border-primary border-opacity-10">
          <div class="card-header border-0">
            <h5 class="card-title mb-0" style="color: #bcbfc4;">📊 This Week's Orders by Category</h5>
          </div>
          <div class="card-body">
            <canvas id="thisweekOrdersChart" height="120"></canvas>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-12">
        <div class="card custom-card">
          <div class="card-header border-0" style="background:#4e4eff; color:white;">
            <h5 class="card-title mb-0">📋 This Week's Order Details</h5>
          </div>
...
<script>
const ctx = document.getElementById('thisweekOrdersChart').getContext('2d');
