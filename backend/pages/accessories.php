...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['id']) && $_POST['id'] != '') {
        // Update
        $id = $_POST['id'];
        $conn->query("UPDATE accessories SET name='$name' WHERE id=$id");
    } else {
        // Add
        $conn->query("INSERT INTO accessories (name) VALUES ('$name')");
    }
}
...
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
    $result = $conn->query("SELECT * FROM accessories WHERE id=$id");
    $edit = $result->fetch_assoc();
}
?>
<div class="main-content app-content">
    <div class="container-fluid">
    <h2 class="my-3">Accessories Category</h2>
