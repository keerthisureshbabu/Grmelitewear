...
if (empty($product_code) && $variation_id > 0) {
    $stmt = $conn->prepare("SELECT product_code FROM accessories_products WHERE id = ? LIMIT 1");
...
$masterExists = false;
$masterTable = "accessories_products_master";
...
// fetch variations
$pstmt = $conn->prepare("SELECT * FROM accessories_products WHERE product_code = ? ORDER BY id ASC");
...
$relCategory = in_array($catParam, ['kids','women','womens','toys','accessories']) ? $catParam : 'accessories';
    ...
    <div class="container container-lg">
        <div class="breadcrumb-wrapper flex-between flex-wrap gap-16">
            ...
            <ul class="flex-align gap-8 flex-wrap">
                ...
                <li class="text-sm text-main-600">Accessories</li>
            </ul>
        </div>
    </div>
</div>
...
<section class="product-details py-80">
    <div class="container container-lg">
        ...
        $preferred = $tableMap[$relCategory] ?? $tableMap['accessories'];
        ...
        foreach (['accessories_products'] as $vt) {
        ...
        <?php if (!empty($related)): ?>
            <div class="row mt-24">
                ...
                <?php foreach ($related as $rel):
                    ...
                    $source = $rel['source_table'] ?? 'accessories_products';
                    if ($source === 'master') { $source = 'accessories_products'; }
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="200">
                        <div class="product-card p-16 border border-gray-100 hover-border-main-600 rounded-16 bg-white transition-2">
                            <div class="product-card__thumb">
                                <a href="accessories_product_detail.php?product_code=<?= h($rel_code) ?>">
                                    <img src="<?= h($rel_img) ?>" alt="<?= h($rel_name) ?>">
                                </a>
                            </div>
                            <div class="product-card__content">
                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                    <a href="accessories_product_detail.php?product_code=<?= h($rel_code) ?>" class="link text-line-2">
                                        <?= h($rel_name) ?>
                                    </a>
                                </h6>
                                ...
                                <form method="GET" action="accessories_product_detail.php">
