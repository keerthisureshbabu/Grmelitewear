...
// Table names
$categoryTable = "accessories"; 
$productTable = "accessories_products";
                    ...
                    <div class="shop-sidebar__box border border-gray-100 rounded-8 p-32 mb-32">
                        ...
                        <ul class="max-h-540 overflow-y-auto scroll-sm">
                            <?php while($cat = $categories->fetch_assoc()): ?>
                                <li class="mb-24">
                                    <a href="accessories.php?cat=<?= $cat['id']; ?>" class="text-gray-900 hover-text-main-600">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="200">
                                        <div class="product-card p-16 border border-gray-100 hover-border-main-600 rounded-16 bg-white transition-2">
                                            ...
                                            <div class="product-card__thumb">
                                                <a href="product-details.php?id=<?= $row['id']; ?>&type=accessories">
                                            ...
                                            <div class="product-card__content">
                                                <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                                    <a href="product-details.php?id=<?= $row['id']; ?>&type=accessories" class="link text-line-2">
